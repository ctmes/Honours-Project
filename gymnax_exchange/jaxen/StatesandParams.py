...
class SpoofingAgentState():
    ...
    volume_injected: float       # cumulative injected volume this episode (budget / OTR accounting)
    volume_last_step: float      # volume injected on the PREVIOUS step (accidental-fill cost)
